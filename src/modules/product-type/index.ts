...
const productTypeRoutes = (app: express.Application): void => {
  ...
  app.get('/api/v1/product-type', productTypeController.fetchProductTypeListAction);
  app.get('/api/v1/product-type/:id', productTypeController.fetchProductTypeInfoAction);
